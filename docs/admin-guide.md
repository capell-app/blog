...
![Create or update an article with publishing windows, metadata, layout selection, media, and tags.](screenshots/create-edit-article-form.png)
...
![Review the article queue, publish windows, language coverage, and article status before editing content.](screenshots/articles-admin-index.png)
